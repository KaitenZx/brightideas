...
_(Remember to provide test credentials if needed for login, or describe the sign-up process)_

---

## 📸 Screenshots

_[FILL ME IN: Add several screenshots or GIFs here demonstrating key screens and features of the application.]_
...
- **Secure & Flexible Environment Management:** Use of `.env` files for different environments, strict Zod validation of variables at application startup. Implemented a secure mechanism to pass _only necessary_ variables from backend to frontend (`window.webappEnvFromBackend`) without baking them into the bundle.
...
1.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/KaitenZx/BrightIdeas.git
    cd BrightIdeas
    ```
